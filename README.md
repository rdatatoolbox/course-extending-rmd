## :mortar_board: Extending Rmarkdown <img src="https://raw.githubusercontent.com/rstudio/rmarkdown/main/man/figures/logo.png" height="120" align="right"/>

[![License: CC
BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgreen.svg)](https://choosealicense.com/licenses/cc-by-4.0/)


Code used to create the online presentation **Extending Rmarkdown** available at:
[**rdatatoolbox.github.io/course-extending-rmd**](https://rdatatoolbox.github.io/course-extending-rmd)
...
[`DESCRIPTION`](https://github.com/rdatatoolbox/course-extending-rmd/blob/main/DESCRIPTION)
file.
...
[`index.Rmd`](https://github.com/rdatatoolbox/course-extending-rmd/blob/main/index.Rmd) 
